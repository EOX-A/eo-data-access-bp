...
include::clause_06_introduction.adoc[]

include::clause_07_cross-service-interaction.adoc[]

include::clause_08_rangetype-description-enhancements.adoc[]

include::clause_09_coverage_collections.adoc[]

include::clause_10_condense-coverage-description-information.adoc[]

include::clause_11_wcs-masking-extension.adoc[]

include::clause_12_conclusions.adoc[]
