...
Please send any suggestions for future work to the document editor or
contributors named above.
...
include::1_base.adoc[]
include::2_cross-service-interaction.adoc[]
include::3_grouping-of-associated-data.adoc[]
include::4_collection-and-product-registration.adoc[]
include::5_condense-coverage-description-information.adoc[]
include::6_uniform-coverage-grouping.adoc[]
include::7_wcs-masking-extension.adoc[]
include::8_rangetype-description-enhancements.adoc[]
